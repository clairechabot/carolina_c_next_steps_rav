"""the candidate's LinkedIn -> application tracker (VM-only, zero manual entry).

Runs in the LinkedIn Scan (VM) workflow with THE JOB SEEKER'S session
(~/.config/linkedin-auth-candidate.json - see SHEET-SETUP.md Part 6; distinct
...
AUTH_FILE = Path.home() / ".config" / "linkedin-auth-candidate.json"
